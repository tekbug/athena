...
config :athena, AthenaWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "g1S5Wx2gDnFcpYYzUKBLS3Afvxi+Xzjr0aIiQBR5XkMAseEZpXF8xsg1v2F1UxyW",
  watchers: [
...
config :athena, AthenaWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/athena_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :athena, dev_routes: true
